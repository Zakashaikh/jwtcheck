...
| vroomfondel/jwtjwkhelper | R03 | CRITICAL | jwtjwkhelper\jwtjwkhelper.py:159 | `decoded_unverified: dict[str, Any] = jwt.decode(jwttoken, verify=False` |  |
| vroomfondel/jwtjwkhelper | R04 | CRITICAL | jwtjwkhelper\jwtjwkhelper.py:196 | `decoded: dict = jwt.decode(` |  |
| vroomfondel/jwtjwkhelper | R08 | MEDIUM | jwtjwkhelper\jwtjwkhelper.py:196 | `decoded: dict = jwt.decode(` |  |
| vroomfondel/jwtjwkhelper | R09 | MEDIUM | jwtjwkhelper\jwtjwkhelper.py:196 | `decoded: dict = jwt.decode(` |  |
| ioxiocom/pyjwt-key-fetcher | R03 | CRITICAL | pyjwt_key_fetcher\fetcher.py:88 | `payload = jwt.decode(token, options={"verify_signature": False})` |  |
...
| crgwbr/asymmetric-jwt-auth | R03 | CRITICAL | asymmetric_jwt_auth\tokens.py:77 | `unverified_data = jwt.decode(self.token, options={"verify_signature": ` |  |
| crgwbr/asymmetric-jwt-auth | R08 | MEDIUM | asymmetric_jwt_auth\tokens.py:88 | `token_data = jwt.decode(` |  |
| crgwbr/asymmetric-jwt-auth | R09 | MEDIUM | asymmetric_jwt_auth\tokens.py:88 | `token_data = jwt.decode(` |  |
...
| MrThearMan/jwt-email-auth | R03 | CRITICAL | jwt_email_auth\rotation\models.py:27 | `payload = jwt.decode(jwt=token, options={"verify_signature": False})` |  |
...
| max-pfeiffer/keycloak-jwt-checker | R03 | CRITICAL | keycloak_jwt_checker\__init__.py:92 | `decode(` |  |
| max-pfeiffer/keycloak-jwt-checker | R03 | CRITICAL | keycloak_jwt_checker\__init__.py:102 | `decode(id_token, client_secret, options={"verify_signature": False}),` |  |
| max-pfeiffer/keycloak-jwt-checker | R03 | CRITICAL | keycloak_jwt_checker\__init__.py:110 | `decode(` |  |
...
| varunbaisane/jwt-vulnerability-analyzer | R03 | CRITICAL | utils\jwt_parser.py:6 | `payload = jwt.decode(token, options={"verify_signature": False})` |  |
| mano8/fa-auth-m8 | R09 | MEDIUM | auth_user_service\services\service_token.py:94 | `payload = jwt.decode(` |  |
| jamescrowley321/py-identity-model | R05 | HIGH | examples\jarm_example.py:195 | `none_jwt = encode(_base_claims(), key="", algorithm="none")` |  |
| jamescrowley321/py-identity-model | R05 | HIGH | examples\jarm_example.py:199 | `hs_jwt = encode(` |  |
| jamescrowley321/py-identity-model | R01 | CRITICAL | src\py_identity_model\core\jwt_helpers.py:116 | `return decode(jwt, pyjwk, **kwargs)` |  |
| jamescrowley321/py-identity-model | R08 | MEDIUM | src\py_identity_model\core\jwt_helpers.py:116 | `return decode(jwt, pyjwk, **kwargs)` |  |
| jamescrowley321/py-identity-model | R09 | MEDIUM | src\py_identity_model\core\jwt_helpers.py:116 | `return decode(jwt, pyjwk, **kwargs)` |  |
